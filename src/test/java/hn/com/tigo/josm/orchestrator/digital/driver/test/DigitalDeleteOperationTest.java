...
public class DigitalDeleteOperationTest extends AbstractTest {

	public DigitalDeleteOperationTest() throws AdapterException {

	}

	@Test
	public void test() {
		final DigitalDeleteOperation operation = new DigitalDeleteOperation(getRequest());
		try {
	...
	public DeleteServiceRequest getRequest() {
		...
		DeleteServiceRequest testeo = null;
		try {
			Gson gson = new Gson();
			testeo = gson.fromJson(json, DeleteServiceRequest.class);
			return testeo;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Test
	public void testErr() {
		final DigitalDeleteOperation operation = new DigitalDeleteOperation(getRequestErr());
		try {
			final TaskResponseType response = driver.executeDriver(operation);
			System.out.println(response.getResponseCode());
			assertEquals(0, response.getResponseCode());
	...
	public DeleteServiceRequest getRequestErr() {
